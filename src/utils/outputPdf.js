 ...
 * @param {boolean} [param.headerFromContent=true] - 页眉是否从内容开始
 * @param {boolean} [param.footerFromContent=true] - 页脚是否从内容开始
